...
class StringWrapper(object):
    ...
    def __init__(self, value, case_sensitive=False, default_similarity_threshold=DEFAULT_THRESHOLD):
        ...
        self._value = value # comienza con un guion bajo porque oculta esa variable
    ...
    def boolean_search(self, pattern, exact=False):
        return self.contains(pattern, reverse=True) if exact else self.similar_enought(pattern, threshold=threshold)
